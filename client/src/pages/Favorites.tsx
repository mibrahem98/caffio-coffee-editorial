...
const copy = {
  ...
  ar: { back: "العودة إلى كافيو", eyebrow: "كافيو / القهوة المفضلة", titleA: "احتفظ", titleB: "بالجيد قريبًا.", intro: "رف محلي للقهوة التي تريد العودة إليها. يُحفظ معرّف المنتج فقط في هذا المتصفح.", empty: "لا توجد قهوة مفضلة بعد.", emptyBody: "افتح صفحة تفاصيل منتج واستخدم القلب لحفظ القهوة هنا.", explore: "استكشف المجموعة", remove: "إزالة", add: "أضف إلى السلة", added: "تمت الإضافة إلى سلتك.", clear: "مسح المفضلة", local: "محلي فقط / لا يتطلب حسابًا" },
};
