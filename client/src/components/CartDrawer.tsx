...
const copy = {
  ...
  ar: { kicker: "ميزان / متجر تجريبي", title: "سلة قهوتك", empty: "السلة بانتظار أول تحميص.", emptyHint: "اختر قهوة من المجموعة لبدء الطقس.", continue: "تابع الاستكشاف", subtotal: "الإجمالي التجريبي", discount: "كود الخصم", apply: "تطبيق", discountPlaceholder: "جرّب MIZAN10", demo: "محاكاة الطلب / لا تتم معالجة أي دفعة", checkout: "محاكاة إتمام الطلب", added: "تم تطبيق العرض", invalid: "هذا الكود التجريبي غير نشط.", complete: "طلبك التجريبي جاهز.", completeBody: "هذه محاكاة أمامية فقط. اربط متجرًا فعليًا لقبول الطلبات الحقيقية.", track: "تتبع هذا الطلب التجريبي", reset: "ابدأ طلبًا جديدًا", remove: "إزالة" },
};
