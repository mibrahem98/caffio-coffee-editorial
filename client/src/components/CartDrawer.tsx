...
const copy = {
  en: { kicker: "MIZAN / DEMO SHOP", title: "Your coffee cart", empty: "Your cart is waiting for its first roast.", emptyHint: "Choose a coffee from the collection to begin the ritual.", continue: "Continue exploring", subtotal: "Demo subtotal", discount: "Discount code", apply: "Apply", discountPlaceholder: "Try MIZAN10", demo: "Demo checkout / no payment is processed", checkout: "Simulate checkout", added: "Offer applied", invalid: "That demo code is not active.", removed: "Offer removed", complete: "Your demo order is ready.", completeBody: "This is a front-end simulation. Connect a commerce backend to accept real orders.", reset: "Start another order", remove: "Remove" },
  ar: { kicker: "ميزان / متجر تجريبي", title: "سلة قهوتك", empty: "السلة بانتظار أول تحميص.", emptyHint: "اختر قهوة من المجموعة لبدء الطقس.", continue: "تابع الاستكشاف", subtotal: "الإجمالي التجريبي", discount: "كود الخصم", apply: "تطبيق", discountPlaceholder: "جرّب MIZAN10", demo: "محاكاة الطلب / لا تتم معالجة أي دفعة", checkout: "محاكاة إتمام الطلب", added: "تم تطبيق العرض", invalid: "هذا الكود التجريبي غير نشط.", removed: "تمت إزالة العرض", complete: "طلبك التجريبي جاهز.", completeBody: "هذه محاكاة أمامية فقط. اربط متجرًا فعليًا لقبول الطلبات الحقيقية.", reset: "ابدأ طلبًا جديدًا", remove: "إزالة" },
};

const offers: Record<string, number> = { MIZAN10: 10, RITUAL15: 15 };
